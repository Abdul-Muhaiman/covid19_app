...
/// active : 11876
/// critical : 45
/// casesPerOneMillion : 5130
/// deathsPerOneMillion : 194
/// tests : 1195818
/// testsPerOneMillion : 29342
/// population : 40754388
/// continent : "Asia"
...
/// recoveredPerOneMillion : 4645.17
...
class WorldCountriesModel {
  ...
  WorldCountriesModel.fromJson(dynamic json) {
...
WorldCountriesModel copyWith({  num? updated,
  String? country,
  CountryInfo? countryInfo,
  num? cases,
  num? todayCases,
  ...
  num? recoveredPerOneMillion,
  num? criticalPerOneMillion,
}) => WorldCountriesModel(  updated: updated ?? _updated,
